...
def main8():
    ...
    selected_range5 = st.sidebar.selectbox("Select Timeframe:", ["All", "1W", "1M", "1Q", "1Y"])
    ...
    plots_and_titles = [
        (plot23, "Value Locked by Category"),
        (plot24, "Value Locked by Blockchain"),
        (plot25, "Total Stablecoin Supply"),
        (plot26, "Value Locked: Liquid Staking")
    ]

    for plot, title in plots_and_titles:
        plot.update_xaxes(
            range=button_ranges_combined[selected_range5],
