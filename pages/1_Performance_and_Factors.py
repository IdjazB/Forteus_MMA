...
with tab1:
    ...
    def create_plot50():
        ...
        #last_week_premium = output_dataframe50.loc[(output_dataframe50['date'].dt.date >= last_week_start_date) & (output_dataframe50['date'].dt.date <= last_week_date)]
        #last_week_premium = last_week_premium['Premium'].values[-1]

        # Format dominance values as percentages
        current_premium_btc_str = f'{current_premium_btc:.2f}%'
        #last_week_premium_str = f'{last_week_premium:.2f}%'
        ...
        # Calculate the change values as percentages
        #last_week_change = current_premium - last_week_premium
    ...
    if plot50 is not None and plot51 is not None:
        ...
        button_labels_premium_btc = ["1M", "1Q", "1Y", "3Y", "All"]
        ...
        button_labels_premium_eth = ["1M", "1Q", "1Y", "3Y", "All"]
