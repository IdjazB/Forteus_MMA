...
driver = "{SQL Server}"
server = "10.20.3.85"
database = "DB_FORTEUS_WF_test"
username = "sa"
password = 'Numeus"2022!!!'
...
sql_query = """
    select A3.ALIAS, A7.NAME, A0.STARTDATE, A8.NAME, A6.TOPIC, A5.PLACE, A4.NAME
    from EVENT A0
    INNER JOIN SCHEDULEDOBJECT A1
        LEFT OUTER JOIN SCHEDULEDOBJECTRELATION A2
            LEFT OUTER JOIN IDENTIFIEDASSET A3
                LEFT OUTER JOIN ISOSTATUS A4
                ON A3.ISOSTATUSID = A4.ID
            ON A2.OBJECTID = A3.SEEDID
        ON A1.SCHEDULEDSEEDID = A2.SCHEDULEDOBJECT AND A2.CLASSID = 294401501
    ON A0.SCHEDULEDSEEDID = A1.SCHEDULEDSEEDID
    LEFT OUTER JOIN APPOINTMENT A5
        INNER JOIN MEETINGNOTES A6
            LEFT OUTER JOIN INTERACTIONTYPE A7
                ON A6.INTERACTIONTYPE = A7.SEEDID
            LEFT OUTER JOIN MEETINGSUBJECT A8
                ON A6.SUBJECTTYPE = A8.SEEDID
        ON A5.SCHEDULEDSEEDID = A6.SCHEDULEDSEEDID
    ON A0.SCHEDULEDSEEDID = A5.SCHEDULEDSEEDID
    where A1.CLASSID = 499826707
"""
sql_query_1 = """
    select A1.ALIAS, A0.ISOSTATUS, A0.ISODATE, A0.VERSIONDATE
    from ISOSTATUSVERSIONS A0, IDENTIFIEDASSET A1
    where A0.SECURITY = A1.SEEDID
    order by A1.ALIAS, A0.VERSIONSEED
"""
sql_query_2 = """
    select A6.NAME as AssignedTo, A0.STATUS, A1.COMMENTS, A3.ALIAS, A7.STARTDATE, A7.ENDDATE, A4.NAME
    from TASK A0
    LEFT OUTER JOIN SCHEDULEDOBJECT A1
        LEFT OUTER JOIN SCHEDULEDOBJECTRELATION A2
            LEFT OUTER JOIN IDENTIFIEDASSET A3
                LEFT OUTER JOIN ISOSTATUS A4
                ON A3.ISOSTATUSID = A4.ID
        ...
        ON A1.SCHEDULEDSEEDID = A2.SCHEDULEDOBJECT AND A2.CLASSID = 294401501
    ON A0.SCHEDULEDSEEDID = A1.SCHEDULEDSEEDID
    LEFT OUTER JOIN USERS A5
    ON A0.ASSIGNEE = A5.USERSEEDID
    INNER JOIN USERS A6
    ON A0.ASSIGNEE = A6.USERSEEDID
    INNER JOIN EVENT A7
    ON A0.SCHEDULEDSEEDID = A7.SCHEDULEDSEEDID
"""
def show_events():
    #EVENTS
